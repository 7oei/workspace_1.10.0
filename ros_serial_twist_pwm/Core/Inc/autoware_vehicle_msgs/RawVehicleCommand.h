#ifndef _ROS_autoware_vehicle_msgs_RawVehicleCommand_h
#define _ROS_autoware_vehicle_msgs_RawVehicleCommand_h
...
namespace autoware_vehicle_msgs
{
  ...
  class RawVehicleCommand : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_vehicle_msgs/RawVehicleCommand"; };
    const char * getMD5(){ return "2dfe6af16f948ae41186c0fd4b4d9275"; };
