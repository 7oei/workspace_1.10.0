#ifndef _ROS_livox_ros_driver_CustomPoint_h
#define _ROS_livox_ros_driver_CustomPoint_h
...
namespace livox_ros_driver
{
  ...
  class CustomPoint : public ros::Msg
  {
    ...
    const char * getType(){ return "livox_ros_driver/CustomPoint"; };
    const char * getMD5(){ return "109a3cc548bb1f96626be89a5008bd6d"; };
