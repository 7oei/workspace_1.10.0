#ifndef _ROS_autoware_planning_msgs_PathPointWithLaneId_h
#define _ROS_autoware_planning_msgs_PathPointWithLaneId_h
...
namespace autoware_planning_msgs
{
  ...
  class PathPointWithLaneId : public ros::Msg
  {
    public:
      typedef autoware_planning_msgs::PathPoint _point_type;
      _point_type point;
    ...
    const char * getType(){ return "autoware_planning_msgs/PathPointWithLaneId"; };
    const char * getMD5(){ return "76ff2694b5d561459dd969c578f7a19d"; };
